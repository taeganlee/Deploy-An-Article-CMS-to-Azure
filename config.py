...
class Config(object):
    ...
    BLOB_ACCOUNT = 'udacityadmin'
    BLOB_STORAGE_KEY = '6o6jgm7NF10EyWRhpyHNK3NZ0ywvn3DiRrBe8nx0U3RECinvwHZiXSZ6wyDQhrl3rQExdTx3NOHrOMFTcnzFWQ=='
    ...
    SQL_SERVER = 'server-japan-east.database.windows.net'
    SQL_DATABASE = 'database-japan-east'
    SQL_USER_NAME = 'udacityadmin'
    SQL_PASSWORD = 'p@ssword1234'
 ...
 #   CLIENT_SECRET = "ENTER_CLIENT_SECRET_HERE"
    CLIENT_SECRET = "r~uj32P4I67GHedecp7j~~-_VCp~8.vQHW"
...
#    CLIENT_ID = "ENTER_CLIENT_ID_HERE"
    CLIENT_ID = "27051f73-1357-482c-966a-7b4fbde28eea"
